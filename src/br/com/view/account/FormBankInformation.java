...
public class FormBankInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTresultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Email", "Telefone", "Saldo", "Numero da conta", "Data de criação"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBankInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBankInformation().setVisible(true);
            }
        });
    }
